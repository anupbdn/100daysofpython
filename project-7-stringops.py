...
for transactions in daily_transactions_split:
  trasaction_clean_data=[]
  for data in transactions:
    y=data.replace("\n","").strip(" ")
    trasaction_clean_data.append(y)
  transactions_clean.append(trasaction_clean_data)
...
for i in colors:
  x = color_count(i)
  print(f'Today {x} {i} threads were sold')
